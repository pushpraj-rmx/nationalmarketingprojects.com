...
function va(a,b){a.l={Pa:b,Ua:!0};a.i=a.o||a.s}
...
function za(a){a.o=0;var b=a.l.Pa;a.l=null;return b}
function Aa(a){a.I=[a.l];a.o=0;a.s=0}
function Ba(a){var b=a.I.splice(0)[0];(b=a.l=a.l||b)?b.Ua?a.i=a.o||a.s:void 0!=b.v&&a.s<b.v?(a.i=b.v,a.l=null):a.i=a.s:a.i=0}
...
function Fa(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.A=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,va(a.i,c)}a.i.A=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.Ua)throw b.Pa;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
b.prototype.xa=function(g){if(g===this)this.s(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.eb(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.wa(g):this.o(g)}};
b.prototype.wa=function(g){var h=void 0;try{h=g.then}catch(k){this.s(k);return}"function"==typeof h?this.fb(h,g):this.o(g)};
...
b.race=function(g){return new b(function(h,k){for(var l=u(g),m=l.next();!m.done;m=l.next())d(m.value).oa(h,k)})};
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,m){function q(y){return function(z){t[y]=z;p--;0==p&&l(t)}}
var t=[],p=0;do t.push(void 0),p++,d(k.value).oa(q(t.length-1),m),k=h.next();while(!k.done)})};
return b});
...
c.prototype=b.prototype;a.P=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Rb=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var vc="undefined"!==typeof Uint8Array,xc={};var yc;function zc(a){if(xc!==xc)throw Error("illegal external caller");this.Ka=a;if(null!=a&&0===a.length)throw Error("ByteString should be constructed with non-empty values");}
zc.prototype.isEmpty=function(){return null==this.Ka};var Ac="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Bc(a,b){Object.isFrozen(a)||(Ac?a[Ac]|=b:void 0!==a.N?a.N|=b:Object.defineProperties(a,{N:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
...
;function Wc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(a&&!Array.isArray(a)){if(vc&&null!=a&&a instanceof Uint8Array)return uc(a);if(a instanceof zc){var b=a.Ka;null!=b&&"string"!==typeof b&&(vc&&b instanceof Uint8Array?b=uc(b):(La(b),b=null));return null==b?"":a.Ka=b}}}return a}
...
function Zc(a){if(a.Ea===Kc)return a.toJSON();a=Wc(a);return Array.isArray(a)?Yc(a,Zc,$c):a}
function ad(a){if(!a)return a;if("object"===typeof a){if(vc&&null!=a&&a instanceof Uint8Array)return new Uint8Array(a);if(a.Ea===Kc)return a.clone()}return a}
function $c(){}
...
function gd(a,b,c){var d=void 0===d?!1:d;var e=cd(a,c,d);var f=!1;var g=null==e||"object"!==typeof e||(f=Array.isArray(e))||e.Ea!==Kc?f?new b(e):void 0:e;g!==e&&null!=g&&(I(a,c,g,d,!0),Bc(g.u,Dc(a.u)&-33));b=g;if(null==b)return b;G(b.u)&&!G(a.u)&&(b=b.Ja(),I(a,c,b,d));return b}
function hd(a,b,c,d,e){e=void 0===e?!0:e;a.j||(a.j={});var f=a.j[c];d=dd(a,c,2,d);var g=!!(Dc(a.u)&16),h=G(d);h=G(a.u)||h;if(!f){f=[];for(var k=h,l=0;l<d.length;l++){var m=d[l];k=k||G(m);var q=b,t=g,p=!1;p=void 0===p?!1:p;t=void 0===t?!1:t;m=Array.isArray(m)?new q(t?Gc(m):m):p?new q:void 0;void 0!==m&&(f.push(m),h&&Bc(m.u,2))}a.j[c]=f;Ic(d,!k)}b=h||e;e=G(f);b&&!e&&(Object.isFrozen(f)&&(a.j[c]=f=f.slice()),Bc(f,2),Object.freeze(f));!b&&e&&(a.j[c]=f=f.slice());return f}
...
n.Ea=Kc;n.toString=function(){return this.u.toString()};
function qd(a,b){return Wc(b)}
function rd(a,b){b.s&&(a.s=b.s.slice());var c=b.j;if(c){b=b.i;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=f;k=void 0===k?!1:k;f=G(h.u);var l=hd(h,e[0].constructor,g,k,f);g=dd(h,g,0,void 0===k?!1:k);if(!(h=f)&&(h=g)){if(!g)throw Error("cannot check mutability state of non-array");h=!(Dc(g)&8)}if(h){for(h=0;h<l.length;h++)(k=l[h])&&G(k.u)&&!f&&(l[h]=l[h].Ja(),g[h]=l[h].u);Ic(g,!0)}f=l;for(l=0;l<Math.min(f.length,e.length);l++)rd(f[l],e[l])}}else throw Error("unexpected object: type: "+
La(e)+": "+e);}}}}
var od;function sd(a,b,c,d,e,f){(a=a.j&&a.j[c])?(e=f.Aa?Fc(a.slice()):a,jd(b,0<e.length?e[0].constructor:void 0,c,e)):(vc&&d instanceof Uint8Array?e=d.length?new zc(new Uint8Array(d)):yc||(yc=new zc(null)):(Array.isArray(d)&&(e?Bc(d,2):d&&Dc(d)&1&&f.Aa?(e=Array.prototype.slice.call(d),Ec(e,(Dc(d)|0)&-51),d=e):Hc(d)),e=d),I(b,c,e))}
;function td(){nd.apply(this,arguments)}
v(td,nd);td.prototype.Ja=function(){return this};
...
v(L,td);L.prototype.Ja=function(){if(G(this.u)){var a={Aa:!0};var b=G(this.u);if(b&&!a.Aa)throw Error("copyRepeatedFields must be true for frozen messages");b||Hc(this.u);var c=new this.constructor;this.s&&(c.s=this.s.slice());for(var d=this.u,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Lc(f))for(var g in f){var h=+g;Number.isNaN(h)?bd(c)[g]=f[g]:sd(this,c,h,f[g],b,a)}else sd(this,c,e-this.l,f,b,a)}c.o=this;a=c}else a=this;return a};
...
return a}
var Jd={zb:"allow-forms",Ab:"allow-modals",Bb:"allow-orientation-lock",Cb:"allow-pointer-lock",Db:"allow-popups",Eb:"allow-popups-to-escape-sandbox",Fb:"allow-presentation",Gb:"allow-same-origin",Hb:"allow-scripts",Ib:"allow-top-navigation",Jb:"allow-top-navigation-by-user-activation"},Ld=ab(function(){return Kd()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,ib:function(){for(var q=d(),t="",p=0;p<q.length;p++)t+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return t}}}
...
function ae(a){var b=Wd();b.update(a);return b.ib().toLowerCase()}
...
if("undefined"!==typeof a&&!F("Trident")&&!F("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.Na;c.Na=null;e()}};
return function(e){d.next={Na:e};d=d.next;b.port2.postMessage(0)}}return function(e){A.setTimeout(e,0)}}
...
function qg(a,b,c,d){var e=Tf(null,null,null);e.i=new Pf(function(f,g){e.j=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
...
D(rg,Xa);rg.prototype.name="cancel";function O(a){he.call(this);this.A=1;this.m=[];this.o=0;this.i=[];this.j={};this.D=!!a}
...
n.ba=function(){O.P.ba.call(this);this.clear();this.m.length=0};function Eg(a){this.i=a}
...
(q=wd.screen)?void 0:q.availWidth;var t;e.u_cd=null==(t=wd.screen)?void 0:t.colorDepth}catch(Y){}h=b.i;try{var p=h.screenX;var y=h.screenY}catch(Y){}try{var z=h.outerWidth;var H=h.outerHeight}catch(Y){}try{var K=h.innerWidth;var M=h.innerHeight}catch(Y){}try{var N=h.screenLeft;var ob=h.screenTop}catch(Y){}try{K=h.innerWidth,M=h.innerHeight}catch(Y){}try{var wc=h.screen.availWidth;var ya=h.screen.availTop}catch(Y){}p=[N,ob,p,y,wc,ya,z,H,K,M];y=b.i.top;try{var sa=(y||window).document,Z="CSS1Compat"==
...
return k}
;var Bi={Ob:"WEB_DISPLAY_MODE_UNKNOWN",Kb:"WEB_DISPLAY_MODE_BROWSER",Mb:"WEB_DISPLAY_MODE_MINIMAL_UI",Nb:"WEB_DISPLAY_MODE_STANDALONE",Lb:"WEB_DISPLAY_MODE_FULLSCREEN"};function Ci(){if(!A.matchMedia)return"WEB_DISPLAY_MODE_UNKNOWN";try{return A.matchMedia("(display-mode: standalone)").matches?"WEB_DISPLAY_MODE_STANDALONE":A.matchMedia("(display-mode: minimal-ui)").matches?"WEB_DISPLAY_MODE_MINIMAL_UI":A.matchMedia("(display-mode: fullscreen)").matches?"WEB_DISPLAY_MODE_FULLSCREEN":A.matchMedia("(display-mode: browser)").matches?"WEB_DISPLAY_MODE_BROWSER":"WEB_DISPLAY_MODE_UNKNOWN"}catch(a){return"WEB_DISPLAY_MODE_UNKNOWN"}}
...
function Ji(){return{innertubeApiKey:Q("INNERTUBE_API_KEY"),innertubeApiVersion:Q("INNERTUBE_API_VERSION"),Ba:Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ra:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),ob:Q("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ta:Q("INNERTUBE_CONTEXT_HL"),Sa:Q("INNERTUBE_CONTEXT_GL"),pb:Q("INNERTUBE_HOST_OVERRIDE")||"",rb:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),qb:!!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:Q("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Ki(a){var b={client:{hl:a.Ta,gl:a.Sa,clientName:a.Ra,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ba}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=A.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Q("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=ji();0<c.length&&(b.request={internalExperimentFlags:c});Li(a,void 0,b);Mi(void 0,b);Ni(a,void 0,b);Oi(void 0,b);Q("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&
...
function Pi(a){var b=new fh,c=new Zg;I(c,1,a.Ta);I(c,2,a.Sa);I(c,16,a.ob);I(c,17,a.innertubeContextClientVersion);if(a.Ba){var d=a.Ba,e=new Vg;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);J(c,Vg,62,e)}(d=A.devicePixelRatio)&&1!=d&&I(c,65,d);d=Q("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=ji();if(0<d.length){e=new ah;for(var f=0;f<d.length;f++){var g=new Tg;I(g,1,d[f].key);g.setValue(d[f].value);
...
function Li(a,b,c){a=a.Ra;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=gd(b,Wg,96)||new Wg;var d=Ci();d=Object.keys(Bi).indexOf(d);d=-1===d?null:d;null!==d&&I(c,3,d);J(b,Wg,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Ci())}
...
function Qi(a,b,c){c=void 0===c?{}:c;var d={};Q("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":Q("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Qb||Q("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Pb:b=ge([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new U("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",Vb:e.name})];e.level="WARNING";return e}
...
function Uj(a,b){return Jk(a,{query:b},function(c){return c.delete().then(function(){return c.continue()})}).then(function(){})}
...
n.update=function(a){return W(this.cursor.update(a))};function Ok(a,b,c){return new Promise(function(d,e){function f(){t||(t=new Lj(g.result,{closed:q}));return t}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.xb,m=c.upgrade,q=c.closed,t;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&kj("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:pj(a)});var y=f(),z=new Qj(g.transaction);
...
function Vk(a){function b(){var f,g,h,k,l,m,q,t,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",wa(z,2),w(z,a.l(a.name,a.options.version,d),4);case 4:h=z.j;for(var H=a.options,K=[],M=u(Object.keys(H.ga)),N=M.next();!N.done;N=M.next()){N=N.value;var ob=H.ga[N],wc=void 0===ob.vb?Number.MAX_VALUE:ob.vb;!(h.i.version>=ob.za)||h.i.version>=wc||h.i.objectStoreNames.contains(N)||K.push(N)}k=K;if(0===k.length){z.v(5);break}l=Object.keys(a.options.ga);m=h.objectStoreNames();
...
a.m=!1,Tk(a,p);return z.return(t);case 10:throw c(),q instanceof Error&&!R("ytidb_async_stack_killswitch")&&(q.stack=q.stack+"\n"+g.substring(g.indexOf("\n")+1)),zj(q,a.name,"",null!=(y=a.options.version)?y:-1);}})}
function c(){a.i===e&&(a.i=void 0)}
if(!a.m)throw Tk(a);if(a.i)return a.i;var d={blocking:function(f){f.close()},
closed:c,xb:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
...
this.ca=function(){};
this.now=Date.now;this.fa=!1;var b;this.bb=null!=(b=a.bb)?b:100;var c;this.ab=null!=(c=a.ab)?c:1;var d;this.Ya=null!=(d=a.Ya)?d:2592E6;var e;this.Xa=null!=(e=a.Xa)?e:12E4;var f;this.Za=null!=(f=a.Za)?f:5E3;var g;this.B=null!=(g=a.B)?g:void 0;this.qa=!!a.qa;var h;this.pa=null!=(h=a.pa)?h:.1;var k;this.ta=null!=(k=a.ta)?k:10;a.handleError&&(this.handleError=a.handleError);a.ca&&(this.ca=a.ca);a.fa&&(this.fa=a.fa);a.ma&&(this.ma=a.ma);this.C=a.C;this.K=a.K;this.F=a.F;this.H=a.H;this.S=a.S;this.Ga=a.Ga;
this.Fa=a.Fa;pl(this)&&(!this.C||this.C("networkless_logging"))&&ql(this)}
function ql(a){pl(a)&&!a.fa&&(a.i=!0,a.qa&&Math.random()<=a.pa&&a.F.hb(a.B),rl(a),a.H.G()&&a.ka(),a.H.X(a.Ga,a.ka.bind(a)),a.H.X(a.Fa,a.Ma.bind(a)))}
...
n.ka=function(){var a=this;if(!pl(this))throw Aj("throttleSend");this.j||(this.j=this.K.M(function(){var b;return x(function(c){if(1==c.i)return w(c,a.F.Qa("NEW",a.B),2);if(3!=c.i)return b=c.j,b?w(c,sl(a,b),3):(a.Ma(),c.return());a.j&&(a.j=0,a.ka());c.i=0})},this.bb))};
n.Ma=function(){this.K.Z(this.j);this.j=0};
function sl(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!pl(a))throw c=Aj("immediateSend"),c;if(void 0===b.id){e.v(2);break}return w(e,a.F.tb(b.id,a.B),3);case 3:(d=e.j)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(ul(a,b,a.Ya)){e.v(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.v(5);break}return w(e,a.F.aa(b.id,a.B),5);case 5:return e.return();case 4:b.skipRetry||(b=vl(a,b));if(!b){e.v(0);break}if(!b.skipRetry||
...
function rl(a){if(!pl(a))throw Aj("retryQueuedRequests");a.F.Qa("QUEUED",a.B).then(function(b){b&&!ul(a,b,a.Xa)?a.K.M(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.v(2):w(c,a.F.Ha(b.id,a.B),2);rl(a);c.i=0})}):a.H.G()&&a.ka()})}
function tl(a,b){a.cb&&!a.H.G()?a.cb(b):a.handleError(b)}
function pl(a){return!!a.B||a.ma}
function wl(a){var b;return(a=null==a?void 0:null==(b=a.error)?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;var xl=C("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.la;O.prototype.publish=O.prototype.da;O.prototype.clear=O.prototype.clear;B("ytPubsub2Pubsub2Instance",xl);B("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});B("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});B("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});B("ytPubsub2Pubsub2SkipSubKey",null);function yl(a,b){Sk.call(this,a,b);this.options=b;oj(a)}
v(yl,Sk);function zl(a,b){var c;return function(){c||(c=new yl(a,b));return c}}
yl.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ia?jl:il)(a,b,Object.assign({},c))};
yl.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ia?nl:kl)(this.name,a)};
...
;var Ml={},Nl=Al("ServiceWorkerLogsDatabase",{ga:(Ml.SWHealthLog={za:1},Ml),Ia:!0,upgrade:function(a,b){b(1)&&Nj(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
;var cm;function dm(){ol.call(this,{F:{hb:Kl,aa:Jl,Qa:Gl,tb:Hl,Ha:Il,set:El},H:em(),handleError:Mh,ca:Nh,S:fm,now:T,cb:Zl,K:dj(),Ga:"publicytnetworkstatus-online",Fa:"publicytnetworkstatus-offline",qa:!0,pa:.1,ta:ii("potential_esf_error_limit",10),C:R,fa:!(mj()&&"www.youtube-nocookie.com"!==Qb(document.location.toString()))});this.l=new Of;R("networkless_immediately_drop_all_requests")&&Ll();nl("LogsDatabaseV2")}
v(dm,ol);function gm(){var a=C("yt.networklessRequestController.instance");a||(a=new dm,B("yt.networklessRequestController.instance",a),R("networkless_logging")&&fl().then(function(b){a.B=b;ql(a);a.l.resolve();a.qa&&Math.random()<=a.pa&&a.B&&Pl(a.B);R("networkless_immediately_drop_sw_health_store")&&hm(a)}));
return a}
...
function em(){cm||(cm=new am({sb:!0,kb:!0}));return cm}
...
return a}
function om(){if(R("use_new_nwl"))return em();lm||(lm=new am({sb:!0,kb:!0}));return lm}
...
;var Em=A.ytPubsubPubsubInstance||new O,Fm=A.ytPubsubPubsubSubscribedKeys||{},Gm=A.ytPubsubPubsubTopicToKeys||{},Hm=A.ytPubsubPubsubIsSynchronous||{};O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.la;O.prototype.publish=O.prototype.da;O.prototype.clear=O.prototype.clear;B("ytPubsubPubsubInstance",Em);B("ytPubsubPubsubTopicToKeys",Gm);B("ytPubsubPubsubIsSynchronous",Hm);B("ytPubsubPubsubSubscribedKeys",Fm);function Im(){this.store=[];this.i={}}
Im.prototype.storePayload=function(a,b){this.store.push({payload:b,keys:a});a=Jm(a);this.i[a]?this.i[a]++:this.i[a]=1;return a};
Im.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=u(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=u(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?(b.push(e.payload),this.i[Jm(e.keys)]--):c.push(e)}this.store=c;a=Km(this,a);a=u(a);for(c=a.next();!c.done;c=a.next())c=c.value,0<this.i[c]&&Nh(new lj("Transport IMS did not fully extract entries for key:",{sequence:c,Wb:b.length,Ub:this.i[c]}));return b};
...
k.set(b,e),jn(k,h,d,f)):(k=Ym().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),l.set(b,k),gn(l,h,d,e,f));else if(g){e=u(Object.keys(Xm));for(g=e.next();!g.done;g=e.next())l=g.value,g=Ym().extractMatchingEntries({isJspb:!0,cttAuthInfo:l}),0<g.length&&k.set(l,g),delete Xm[l];jn(k,h,d,f)}else{k=u(Object.keys(Xm));for(g=k.next();!g.done;g=k.next()){g=g.value;var m=Ym().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0<m.length&&l.set(g,m);delete Xm[g]}gn(l,h,d,e,f)}}else f=a,k=c,h=Om,f=void 0===f?
...
a?Rm.i=b:Qm.i=b}window.clearTimeout(a?Rm.j:Qm.j);b=Q("LOGGING_BATCH_TIMEOUT",ii("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Sm&&(b=Mm);b=Xh(function(){dn({writeThenSend:!0},void 0,a)},b);
a?Rm.j=b:Qm.j=b}
function gn(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(T()),h=a.size;a=u(a);for(var k=a.next();!k.done;k=a.next()){var l=u(k.value);k=l.next().value;var m=l.next().value;l=k;k=mb({context:Ki(b.config_||Ji())});if(!Ma(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.events=m;(m=Vm[l])&&kn(k,l,m);delete Vm[l];l="visitorOnlyApprovedKey"===l;ln(k,g,l);mn(e);m=function(){h--;h||c()};
var q=function(){h--;h||c()};
try{Zi(b,"log_event",k,nn(e,l,m,q,f)),Sm=!1}catch(t){Mh(t),d()}}}
function jn(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(T()),g=a.size,h=new Map([].concat(ia(a)));h=u(h);for(var k=h.next();!k.done;k=h.next()){var l=u(k.value).next().value,m=a.get(l);k=new Ah;var q=Pi(b.config_||Ji());J(k,fh,1,q);m=m?on(m):[];m=u(m);for(q=m.next();!q.done;q=m.next())kd(k,3,vh,q.value);(m=Wm[l])&&pn(k,l,m);delete Wm[l];l="visitorOnlyApprovedKey"===l;qn(k,f,l);mn(d);k=pd(k);l=nn(d,l,function(){g--;g||c()},function(){g--;
g||c()},e);
...
function nn(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Va:a,ea:b,Sb:!!e,headers:{},postBodyFormat:"",postBody:""};rn()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(T())));return a}
function ln(a,b,c){rn()||(a.requestTimeMs=String(b));R("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=Q("EVENT_ID"))&&(c=sn(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function qn(a,b,c){rn()||I(a,2,b);if(!c&&(b=Q("EVENT_ID"))){c=sn();var d=new xh;I(d,1,b);I(d,2,c);J(a,xh,5,d)}}
function sn(){var a=Q("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Nm/2));a++;a>Nm&&(a=1);Gh("BATCH_CLIENT_COUNTER",a);return a}
...
function rn(){return R("use_request_time_ms_header")||R("lr_use_request_time_ms_header")}
;var tn=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",tn);
function un(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||T());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&Am();a=Dm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.ja&&(a=e.context,b=d.ja,b={index:vn(b),groupKey:b},a.sequence=b,d.mb&&delete tn[d.ja]);(d.wb?fn:Zm)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ea:d.ea},c)}
function wn(a){dn(void 0,void 0,void 0===a?!1:a)}
function vn(a){tn[a]=a in tn?tn[a]+1:0;return tn[a]}
;var xn=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",xn);function yn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;Q("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:wm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||T());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Dm();d=new uh;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.ja){e=b.ja;var f=vn(e),g=new th;I(g,2,f);I(g,1,e);J(d,th,3,g);b.mb&&delete xn[b.ja]}J(a,uh,33,d);(b.wb?hn:cn)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,ea:b.ea},c)}
;function zn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;var d=wm;Q("ytLoggingEventsDefaultDisabled",!1)&&wm===wm&&(d=null);R("web_all_payloads_via_jspb")&&Nh(new lj("Logs should be translated to JSPB but are sent as JSON instead",a));un(a,b,d,c)}else d=wm,Q("ytLoggingEventsDefaultDisabled",!1)&&wm==wm&&(d=null),un(a,b,d,c)}
...
sa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Cn={V:[],T:[{gb:Bn,weight:500}]};function Bn(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Dn(){this.T=[];this.V=[]}
var En;function Fn(){if(!En){var a=En=new Dn;a.V.length=0;a.T.length=0;Cn.V&&a.V.push.apply(a.V,Cn.V);Cn.T&&a.T.push.apply(a.T,Cn.T)}return En}
;var Gn=new O;function Hn(a){function b(){return a.charCodeAt(d++)}
...
;var Mn=new Set,Nn=0,On=0,Pn=0,Qn=[],Rn=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Sn(){for(var a=u(Rn),b=a.next();!b.done;b=a.next()){var c=Kb();if(c&&0<=c.toLowerCase().indexOf(b.value.toLowerCase()))return!0}return!1}
;function Tn(){var a;return x(function(b){return(a=gf())?b.return(a.then(function(c){c=pd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return uc(d,3)})):b.return(Promise.resolve(null))})}
;var Un={};function Vn(a){return Un[a]||(Un[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Wn={},Xn=[],Cg=new O,Yn={};function Zn(){for(var a=u(Xn),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function ao(a){Cg.da.apply(Cg,arguments)}
;function bo(a){this.i=a||{};a=[this.i,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function co(a,b){a=[a.i,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function eo(a,b,c){fo||(fo={},Wh(window,"message",function(d){a:{if(d.origin===co(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=fo[e.id])d.A=!0,d.A&&(E(d.o,d.sendMessage,d),d.o.length=0),d.La(e)}e=void 0}return e}));
fo[c]=b}
var fo=null;var go=window;function ho(a,b,c){this.s=this.i=this.j=null;this.l=0;this.A=!1;this.o=[];this.m=null;this.I={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.D=c;this.setup(a,b)}
n=ho.prototype;n.setSize=function(a,b){this.i.width=a.toString();this.i.height=b.toString();return this};
n.getIframe=function(){return this.i};
n.La=function(a){io(this,a.event,a)};
n.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.m.subscribe(a,c);jo(this,a);return this};
function ko(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.D===b[0]&&jo(a,c)}}
n.destroy=function(){this.i&&this.i.id&&(Wn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.s){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.s,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);fo&&(fo[this.id]=null);this.j=null;a=this.i;for(var c in kb)kb[c][0]==a&&Uh(c);this.s=this.i=null};
n.Oa=function(){return{}};
function lo(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.A?a.sendMessage(b):a.o.push(b)}
function io(a,b,c){a.m.l||(c={target:a,data:c},a.m.da(b,c),ao(a.D+"."+b,c))}
function mo(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,e=b.length;d<e;d++){var f=b[d].value;null!=f&&""!==f&&"null"!==f&&c.setAttribute(b[d].name,f)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","1");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+co(a.j,"title"));(b=co(a.j,"width"))&&c.setAttribute("width",b.toString());(b=co(a.j,"height"))&&c.setAttribute("height",
b.toString());var g=a.Oa();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&E(["debugjs","debugcss"],function(k){var l=Vb(window.location.href,k);null!==l&&(g[k]=l)});
go.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(go.yt_embedsTokenValue),delete go.yt_embedsTokenValue);var h=""+co(a.j,"host")+("/embed/"+co(a.j,"videoId"))+"?"+Tb(g);go.yt_embedsEnableUaChProbe?Tn().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Rd(l.href).toString();Dd(c,Sd(k));return k}):
go.yt_embedsEnableIframeSrcWithIntent?Dd(c,Sd(h)):c.src=h;
return c}
n.Wa=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function no(a){eo(a.j,a,a.id);a.l=Yh(a.Wa.bind(a),250);Wh(a.i,"load",function(){window.clearInterval(a.l);a.l=Yh(a.Wa.bind(a),250)})}
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Rb(a.src):"https://www.youtube.com"),this.j=new bo(b),c||(b=mo(this,a),this.s=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),Wn[this.i.id]=this,window.postMessage){this.m=new O;no(this);b=co(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Yn)Yn.hasOwnProperty(e)&&
ko(this,e)}};
function jo(a,b){a.I[b]||(a.I[b]=!0,lo(a,"addEventListener",[b]))}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=Nn)){var m=void 0,q=void 0,t=f,p=g,y=xd(t),z=y.message||"Unknown Error",H=y.name||"UnknownError",
K=y.stack||t.j||"Not available";if(K.startsWith(H+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var N=y.lineNumber||"Not available",ob=y.fileName||"Not available",wc=K,ya=0;if(t.hasOwnProperty("args")&&t.args&&t.args.length)for(var sa=0;sa<t.args.length&&!(ya=Jn(t.args[sa],"params."+sa,p,ya),500<=ya);sa++);else if(t.hasOwnProperty("params")&&t.params){var Z=t.params;if("object"===typeof t.params)for(q in Z){if(Z[q]){var da="params."+q,ea=Ln(Z[q]);p[da]=ea;ya+=da.length+ea.length;if(500<ya)break}}else p.params=
Ln(Z)}if(Qn.length)for(var Y=0;Y<Qn.length&&!(ya=Jn(Qn[Y],"params.context."+Y,p,ya),500<=ya);Y++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:H,lineNumber:N,fileName:ob,stack:wc,params:p,sampleWeight:1},Vj=Number(t.columnNumber);isNaN(Vj)||(S.lineNumber=S.lineNumber+":"+Vj);if("IGNORED"===t.level)m=0;else a:{for(var Wj=Fn(),Xj=u(Wj.V),Uf=Xj.next();!Uf.done;Uf=Xj.next()){var Yj=Uf.value;if(S.message&&S.message.match(Yj.Tb)){m=Yj.weight;
break a}}for(var Zj=u(Wj.T),Vf=Zj.next();!Vf.done;Vf=Zj.next()){var ak=Vf.value;if(ak.gb(S)){m=ak.weight;break a}}m=1}S.sampleWeight=m;for(var bk=u(An),Wf=bk.next();!Wf.done;Wf=bk.next()){var Xf=Wf.value;if(Xf.sa[S.name])for(var ck=u(Xf.sa[S.name]),Yf=ck.next();!Yf.done;Yf=ck.next()){var dk=Yf.value,Xd=S.message.match(dk.regexp);if(Xd){S.params["params.error.original"]=Xd[0];for(var Zf=dk.groups,ek={},Zb=0;Zb<Zf.length;Zb++)ek[Zf[Zb]]=Xd[Zb+1],S.params["params.error."+Zf[Zb]]=Xd[Zb+1];S.message=Xf.Da(ek);
break}}}S.params||(S.params={});var fk=Fn();S.params["params.errorServiceSignature"]="msg="+fk.V.length+"&cb="+fk.T.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!Mn.has(ua.message)){if("ERROR"===h){Gn.da("handleError",
ua);if(R("record_app_crashed_web")&&0===Pn&&1===ua.sampleWeight)if(Pn++,R("errors_via_jspb")){var $f=new sh;I($f,1,1);if(!R("report_client_error_with_app_crash_ks")){var gk=new nh;I(gk,1,ua.message);var hk=new oh;J(hk,nh,3,gk);var ik=new ph;J(ik,oh,5,hk);var jk=new qh;J(jk,ph,9,ik);J($f,qh,4,jk)}var to=$f,kk=new vh;id(kk,sh,20,wh,to);yn(kk)}else{var lk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(lk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
zn("appCrashed",lk)}On++}else"WARNING"===h&&Gn.da("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var ag=void 0,bg=void 0,Mc=h,P=ua;if(R("errors_via_jspb")){if(Sn())bg=void 0;else{var $b=new kh;I($b,1,P.stack);P.fileName&&I($b,4,P.fileName);var Oa=P.lineNumber&&P.lineNumber.split?P.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(I($b,2,Number(Oa[0])),I($b,3,Number(Oa[1]))):I($b,2,Number(Oa[0])));var vb=
new nh;I(vb,1,P.message);I(vb,3,P.name);I(vb,6,P.sampleWeight);"ERROR"===Mc?I(vb,2,2):"WARNING"===Mc?I(vb,2,1):I(vb,2,0);var cg=new lh;I(cg,1,!0);id(cg,kh,3,mh,$b);var wb=new hh;I(wb,3,window.location.href);for(var mk=Q("FEXP_EXPERIMENTS",[]),dg=0;dg<mk.length;dg++){var nk=wb,uo=mk[dg];Rc(nk);dd(nk,5,2,!1).push(uo)}var eg=Hh();if(!Ih()&&eg)for(var ok=u(Object.keys(eg)),xb=ok.next();!xb.done;xb=ok.next()){var pk=xb.value,fg=new jh;I(fg,1,pk);fg.setValue(String(eg[pk]));kd(wb,4,jh,fg)}var gg=P.params;
if(gg){var qk=u(Object.keys(gg));for(xb=qk.next();!xb.done;xb=qk.next()){var rk=xb.value,hg=new jh;I(hg,1,"client."+rk);hg.setValue(String(gg[rk]));kd(wb,4,jh,hg)}}var sk=Q("SERVER_NAME"),tk=Q("SERVER_VERSION");if(sk&&tk){var ig=new jh;I(ig,1,"server.name");ig.setValue(sk);kd(wb,4,jh,ig);var jg=new jh;I(jg,1,"server.version");jg.setValue(tk);kd(wb,4,jh,jg)}var Yd=new oh;J(Yd,hh,1,wb);J(Yd,lh,2,cg);J(Yd,nh,3,vb);bg=Yd}var uk=bg;if(!uk)break a;var vk=new vh;id(vk,oh,163,wh,uk);yn(vk)}else{if(Sn())ag=
void 0;else{var Nc={stackTrace:P.stack};P.fileName&&(Nc.filename=P.fileName);var Pa=P.lineNumber&&P.lineNumber.split?P.lineNumber.split(":"):[];0!==Pa.length&&(1!==Pa.length||isNaN(Number(Pa[0]))?2!==Pa.length||isNaN(Number(Pa[0]))||isNaN(Number(Pa[1]))||(Nc.lineNumber=Number(Pa[0]),Nc.columnNumber=Number(Pa[1])):Nc.lineNumber=Number(Pa[0]));var kg={level:"ERROR_LEVEL_UNKNOWN",message:P.message,errorClassName:P.name,sampleWeight:P.sampleWeight};"ERROR"===Mc?kg.level="ERROR_LEVEL_ERROR":"WARNING"===
Mc&&(kg.level="ERROR_LEVEL_WARNNING");var vo={isObfuscated:!0,browserStackInfo:Nc},ac={pageUrl:window.location.href,kvPairs:[]};Q("FEXP_EXPERIMENTS")&&(ac.experimentIds=Q("FEXP_EXPERIMENTS"));var lg=Hh();if(!Ih()&&lg)for(var wk=u(Object.keys(lg)),yb=wk.next();!yb.done;yb=wk.next()){var xk=yb.value;ac.kvPairs.push({key:xk,value:String(lg[xk])})}var mg=P.params;if(mg){var yk=u(Object.keys(mg));for(yb=yk.next();!yb.done;yb=yk.next()){var zk=yb.value;ac.kvPairs.push({key:"client."+zk,value:String(mg[zk])})}}var Ak=
Q("SERVER_NAME"),Bk=Q("SERVER_VERSION");Ak&&Bk&&(ac.kvPairs.push({key:"server.name",value:Ak}),ac.kvPairs.push({key:"server.version",value:Bk}));ag={errorMetadata:ac,stackTrace:vo,logMessage:kg}}var Ck=ag;if(!Ck)break a;zn("clientError",Ck)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(wn(!0),!R("web_fp_via_jspb_and_json")))break c;wn()}else{if(R("web_fp_via_jspb")&&(wn(!0),!R("web_fp_via_jspb_and_json")))break b;wn()}}if(!R("suppress_error_204_logging")){var zb=
ua,Oc=zb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Oc.name},postParams:{url:Q("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Oc.version&&($a["client.version"]=Oc.version);if($a.postParams){zb.stack&&($a.postParams.stack=zb.stack);for(var Dk=u(Object.keys(Oc)),ng=Dk.next();!ng.done;ng=Dk.next()){var Ek=ng.value;$a.postParams["client."+Ek]=Oc[Ek]}var og=Hh();if(og)for(var Fk=u(Object.keys(og)),
pg=Fk.next();!pg.done;pg=Fk.next()){var Gk=pg.value;$a.postParams[Gk]=og[Gk]}var Hk=Q("SERVER_NAME"),Ik=Q("SERVER_VERSION");Hk&&Ik&&($a.postParams["server.name"]=Hk,$a.postParams["server.version"]=Ik)}ti(Q("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{Mn.add(ua.message)}catch(Ao){}Nn++}}}}}else throw Yb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function oo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function po(a){return 0===a.search("get")||0===a.search("is")}
;function qo(a,b){ho.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.O={};this.playerInfo={};this.videoTitle=""}
v(qo,ho);n=qo.prototype;n.Oa=function(){var a=co(this.j,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=co(this.j,"embedConfig")){if(Na(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.La=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Na(a))for(var c in a)a.hasOwnProperty(c)&&(this.O[c]=a[c]);break;case "infoDelivery":ro(this,a);break;case "initialDelivery":Na(a)&&(window.clearInterval(this.l),this.playerInfo={},this.O={},so(this,a.apiInterface),ro(this,a));break;default:io(this,b,a)}};
function ro(a,b){if(Na(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.i.setAttribute("title",b))):(a.videoTitle="",a.i.setAttribute("title","YouTube "+co(a.j,"title"))))}}
function so(a,b){E(b,function(c){this[c]||("getCurrentTime"===c?this[c]=function(){var d=this.playerInfo.currentTime;if(1===this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:oo(c)?this[c]=function(){this.playerInfo={};
this.O={};lo(this,c,arguments);return this}:po(c)?this[c]=function(){var d=0;
...
return this})},a)}
n.getVideoEmbedCode=function(){var a=co(this.j,"host")+("/embed/"+co(this.j,"videoId")),b=Number(co(this.j,"width")),c=Number(co(this.j,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);var d=this.videoTitle;Gb.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(Ab,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(Bb,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(Cb,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(Db,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(Eb,
...
function wo(a){if("iframe"!==a.tagName.toLowerCase()){var b=$n(a,"videoid");b&&(b={videoId:b,width:$n(a,"width"),height:$n(a,"height")},new qo(a,b))}}
...
B("YT.scan",Zn);B("YT.subscribe",function(a,b,c){Cg.subscribe(a,b,c);Yn[a]=!0;for(var d in Wn)Wn.hasOwnProperty(d)&&ko(Wn[d],a)});
B("YT.unsubscribe",function(a,b,c){Bg(a,b,c)});
B("YT.Player",qo);ho.prototype.destroy=ho.prototype.destroy;ho.prototype.setSize=ho.prototype.setSize;ho.prototype.getIframe=ho.prototype.getIframe;ho.prototype.addEventListener=ho.prototype.addEventListener;qo.prototype.getVideoEmbedCode=qo.prototype.getVideoEmbedCode;qo.prototype.getOptions=qo.prototype.getOptions;qo.prototype.getOption=qo.prototype.getOption;
Xn.push(function(a){var b=a;b||(b=document);a=gb(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var f={};for(c=d=0;b=e[c];c++){var g=b.className,h;if(h="function"==typeof g.split)h=0<=bb(g.split(/\s+/),
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=gb(b);E(fb(a,b),wo)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Zn();var xo=A.onYTReady;xo&&xo();var yo=A.onYouTubeIframeAPIReady;yo&&yo();var zo=A.onYouTubePlayerAPIReady;zo&&zo();}).call(this);
